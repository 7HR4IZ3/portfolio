...
def depr(major, minor, cause, fix):
	text = "Warning: Use of deprecated feature or wsgic. (Deprecated in Bottle-%d.%d)\n"\
		   "Cause: %s\n"\
...
#: Not a plugin, but part of the plugin wsgic. TODO: Find a better place.
